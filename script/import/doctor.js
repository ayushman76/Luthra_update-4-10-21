...
var dr_02 = new Doctor ('images/dr_saurabh_luthra.png','Dr. Saurabh Luthra','M.B.B.S., D.O., D.N.B.','Phaco Surgeon','dr_saurabh.html');
var dr_03 = new Doctor ('images/dr_kalpana_luthra.jpg','Dr. Kalpana Luthra','M.D (Dermatology)','Cosmetologist','skin_solution.html');
var dr_01 = new Doctor ('images/dr_sk_luthra.jpg','Dr. S.K. Luthra','M.B.B.S., D.O.M.S., ','Eye Specialist','dr_saurabh.html');
...
for(var i in doctor_arr){
	document.querySelector('.doctor>.container>.row').innerHTML+=`
	    <div class="col-md-4">
		     <div class="dr_item wow fadeInUpBig">
			      <div class="dr_img ">
